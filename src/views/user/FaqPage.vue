<template>
  <header class="pb-10 pt-[106px] text-center sm:pb-12 lg:pb-20" data-aos="fade-up" data-aos-duration="800">
    <h3 class="mb-2 font-montserrat text-2xl font-bold tracking-[0.2rem] text-brown-100">FAQ</h3>
    <h2 class="-mt-1 mb-4 font-maru text-5xl font-medium tracking-widest text-brown-300 md:text-[64px]">常見問題</h2>
    ...
    <div class="container">
      <div class="mx-auto lg:w-8/12">
        <div id="accordionExample5">
          <div class="mb-6 rounded-lg border-2 border-brown-200">
            <h4 class="mb-0 font-semibold" id="headingOne5">
              <button
                class="group relative flex w-full items-center gap-1 border-0 px-5 py-4 text-left text-base text-brown-300 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none [&:not([data-te-collapse-collapsed])]:gap-3 [&:not([data-te-collapse-collapsed])]:bg-brown-200 [&:not([data-te-collapse-collapsed])]:text-white [&:not([data-te-collapse-collapsed])]:[box-shadow:inset_0_-1px_0_rgba(229,231,235)]"
                type="button"
            ...
            <div id="collapseOne5" class="!visible hidden" data-te-collapse-item aria-labelledby="headingOne5">
              <div class="px-5 py-4 text-black">
                <p>
                  是的，我們樂意接受定製訂單，無論是生日蛋糕、特殊場合的烘焙點心還是其他需求，但是
                  <span class="font-bold">必需提前預約排單</span>
                  ，請與我們聯繫以討論您的訂製需求。
                </p>
              </div>
            </div>
        ...
        <div id="accordionExample5">
          <div class="mb-6 rounded-lg border-2 border-brown-200">
            ...
            <div id="collapse4" class="!visible hidden" data-te-collapse-item aria-labelledby="headingOne5">
              <div class="px-5 py-4 text-black">
                <p>
                  請您務必於訂單取貨日內，於門市營業時間內取貨（11 : 30～19 : 30），如超過時間未取，
                  恕不保留、退款與補領。
                  <br />
                  建議您若無法親自至門市領取蛋糕，
                  <span class="font-bold">可請親友代領</span>
                  ， 告知門市人員訂單編號、訂購人姓名及手機即可。
                </p>
              </div>
            </div>
          </div>
