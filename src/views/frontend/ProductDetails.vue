<template>
  ...
  <div class="container mb-5 sm:mb-12 mt-28">
    <div class="flex flex-col justify-center md:flex-row">
      <div class="md:pr-10 md:w-5/12 lg:w-4/12">
      ...
      <!-- content -->
      <div class="pt-5 sm:pt-10 md:w-7/12 lg:w-5/12">
        <div class="flex mb-2">
          <div class="inline-block w-11/12 text-3xl font-bold tracking-wide text-black sm:text-4xl font-noto-serif"
  ...
  <div class="container mb-[72px]">
    <h3 class="mb-12 text-4xl font-medium tracking-widest text-center font-maru text-brown-500">更多商品⋯</h3>
    <swiper
      :navigation="true"
      :slidesPerView="4"
      :loop="true"
    ...
    >
      <swiper-slide v-for="product in moreProduct" :key="product.id">
        <div class="w-full px-3 productCard">
            ...
            <div class="p-5 min-h-[150px] flex flex-col justify-between grow">
              ...
              <div class="flex flex-col sm:justify-between sm:items-center sm:flex-row">
                <div class="flex flex-col">
                  <div>
                    <span
                      class="font-medium md::text-xl text-black-light"
                ...
                <button
                  type="button"
                  class="z-10 flex items-center self-end px-6 py-2 text-sm font-medium leading-normal tracking-wider text-white uppercase transition duration-150 ease-in-out rounded-full w-fit btn-add-cart bg-brown-300 focus:outline-none focus:ring-0 active:bg-cerulean-700 hover:opacity-80"
...
export default {
  ...
  computed: {
    ...
    moreProduct() {
      return this.productList.filter((product) => !(product.id === this.productDetails.id));
    },
  },
  watch: {
    $route() {
