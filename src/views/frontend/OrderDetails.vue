<template>
  ...
  <main class="container mt-[106px] min-h-[calc(100vh_-_280px)] pb-10">
    ...
    <!-- search -->
    <div class="w-full mx-auto mb-20 md:block sm:w-7/12 md:w-1/2 xl:w-1/3">
    ...
    <div class="mb-20" v-if="Object.keys(this.orderDetails).length !== 0">
      <!-- <h3 class="text-3xl font-bold text-center text-black mb-14 font-noto-serif">購買者資料</h3> -->
      <div class="relative flex gap-2 px-5 pr-3 mx-auto border rounded-lg py-14 sm:px-10 lg:w-2/3 xl:w-1/2">
        <svg
          ...
          <tbody>
            ...
            <tr class="border-b-2 border-dashed border-brown-100">
              ...
              <td class="py-4 pr-1 sm:tracking-wider sm:pr-4">{{
                orderDetails.user.pickupMethod === 'delivery' ? '宅配' : '到店自取'
              }}</td>
            </tr>
            <tr class="border-b-2 border-dashed border-brown-100">
            ...
            <tr class="border-b-2 border-dashed border-brown-100">
              ...
              <td
                ...
                :class="orderDetails.user.payWay === 'other' ? 'text-success' : 'text-danger'"
                >{{ orderDetails.user.payWay === 'other' ? '已付款' : '尚未付款' }}</td
              >
            </tr>
            <tr class="border-b-2 border-dashed border-brown-100">
    ...
    <div class="mb-10" v-if="Object.keys(this.orderDetails).length !== 0">
                  ...
                  >
                    ...
                    <td class="px-2 py-4 md:px-4 lg:px-6">
                      <div class="flex items-center">
                        ...
                        <span class="hidden pl-2 text-sm text-gray-400 sm:inline-block"> {{ item.product.unit }}</span>
                      </div>
                    </td>
                  </tr>
                </tbody>
                ...
                <tfoot class="text-base font-bold tracking-wider border-t border-gray-200 text-brown-500">
                  ...
                  <td class="px-1 py-4 text-center md:text-start md:px-4 lg:px-6" colspan="3">
                    ...
                    <p class="-ml-2 text-sm">{{
                      orderDetails.user.pickupMethod === 'delivery' ? `（含運費 80 元）` : ''
                    }}</p>
                  </td>
                </tfoot>
              </table>
