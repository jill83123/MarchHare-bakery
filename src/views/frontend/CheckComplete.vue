<template>
  <div data-aos="fade-up" data-aos-duration="800" data-aos-once="true" class="container">
    <div class="mb-9 mt-14">
      <div class="mb-6 flex items-center justify-center gap-2">
        ...
        <h3 class="font-maru text-3xl font-medium text-black">感謝購買</h3>
      </div>
      <p class="text-center">
        我們正在處理您的訂單
        <br />
    ...
    <div class="mb-14">
      <div class="mb-2 flex flex-col items-center justify-center gap-2">
        <h4 class="mr-1 inline-block text-center text-xl tracking-wide">訂單編號</h4>
        <div class="-mr-7">
          <span
      ...
      <p class="text-center text-sm text-danger">※ 請詳記訂單編號，方便查詢詳細資訊</p>
    </div>
