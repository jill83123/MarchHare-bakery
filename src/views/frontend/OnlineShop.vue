<template>
  ...
  <header class="relative">
    ...
    <div class="absolute top-0 bottom-0 left-0 right-0 h-full bg-[#ffffff60] backdrop-blur-md z-1">
      <div class="absolute left-0 right-0 flex flex-col justify-center h-full mx-auto text-center">
        <h3 class="text-2xl tracking-[0.2rem] text-neutral-100 opacity-70 font-montserrat mb-2 font-bold"
          >Online Shop
        </h3>
        <h2 class="md:text-[64px] font-maru text-neutral-50 font-medium tracking-widest text-5xl">線上商店</h2>
      </div>
    </div>
  </header>
  ...
  <main class="container">
    ...
    <!-- list -->
    <div
      class="mb-6 transition-opacity duration-150 ease-linear opacity-100"
  ...
  <Pagination :pages="pagination" @change-page="getProducts" v-if="this.sortStatus === 'all'"></Pagination>
