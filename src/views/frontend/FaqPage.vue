          ...
          <div class="mb-6 border-2 rounded-lg border-brown-200">
            <h2 class="mb-0 font-semibold" id="headingOne5">
              ...
              >
                Q：是否接受客製訂單？
                <span
                  class="-mr-1 self-start ml-auto shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-200 ease-in-out group-[[data-te-collapse-collapsed]]:mr-0 group-[[data-te-collapse-collapsed]]:rotate-0 group-[[data-te-collapse-collapsed]]:fill-[#212529] motion-reduce:transition-none"
                >
                  <svg
            ...
            <div id="collapseOne5" class="!visible hidden" data-te-collapse-item aria-labelledby="headingOne5">
              <div class="px-5 py-4 text-black">
                <p
                  >是的，我們樂意接受定製訂單，無論是生日蛋糕、特殊場合的烘焙點心還是其他需求，但是<span
                    class="font-bold"
                    >必需提前預約排單</span
                  >，請與我們聯繫以討論您的訂製需求。</p
                >
            ...
            <div id="collapse4" class="!visible hidden" data-te-collapse-item aria-labelledby="headingOne5">
              <div class="px-5 py-4 text-black">
                <p
                  ...
                  恕不保留、退款與補領。<br />建議您若無法親自至門市領取蛋糕，<span class="font-bold">可請親友代領</span
                  >， 告知門市人員訂單編號、訂購人姓名及手機即可。</p
                >
              </div>
            </div>
          </div>
