<template>
  <footer class="bg-cream">
    <div class="container relative flex flex-col justify-between py-8 sm:flex-row sm:py-10">
      <div>
        <!-- social -->
        <ul class="mb-4 flex">
          <li>
      ...
      <div class="text-xs sm:self-end">
        <ul class="flex tracking-widest md:justify-end">
          <li class="mb-1">
            <a href="https://github.com/jill83123/MarchHare-bakery" target="_blank" rel="noopener noreferrer">
              GITHUB |
            </a>
          </li>
          <li>
