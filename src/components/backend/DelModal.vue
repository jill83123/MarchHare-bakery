<template>
  <div
    data-te-modal-init
    class="fixed left-0 top-[30%] lg:top-0 z-[1055] hidden h-[full] w-full overflow-y-auto overflow-x-hidden outline-none"
    tabindex="-1"
  ...
  >
    ...
    >
      ...
      >
        <div
          class="flex items-center justify-between flex-shrink-0 p-4 border-b-2 border-opacity-100 rounded-t-md border-neutral-100 bg-danger"
        >
          <!--Modal title-->
