<template>
  <nav aria-label="Page navigation">
    <ul class="flex justify-center list-style-none pb-8 md:py-[68px]">
      <li class="mx-[6px] h-[44px] w-[44px]">
        <a
          class="relative flex items-center justify-center w-full h-full transition-all duration-300 bg-transparent border-2 border-brown-300 text-brown-300 hover:bg-neutral-100"
          href="#"
          aria-label="Previous"
          :class="{ disabled: pages.has_pre === false }"
          @click.prevent="changePage(pages.has_pre, 'pre')"
        >
          <span class="align-middle material-symbols-outlined"> chevron_left </span>
        </a>
      </li>
      ...
      <li class="mx-[6px] h-[44px] w-[44px]">
        ...
        >
          <span class="align-middle material-symbols-outlined"> chevron_right </span>
        </a>
      </li>
    </ul>
  </nav>
